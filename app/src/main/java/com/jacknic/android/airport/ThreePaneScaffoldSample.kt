 ...
 *
 * androidx/androidx  https://github.com/androidx/androidx/blob/androidx-main/compose/material3/adaptive/samples/src/main/java/androidx/compose/material3/adaptive/samples/ThreePaneScaffoldSample.kt
 */
...
fun ListDetailPaneScaffoldWithNavigationSample() {
    ...
    NavHost(
        ...
        composable(listDetailRoute) {
            ...
            ListDetailPaneScaffold(
                directive = scaffoldNavigator.scaffoldDirective.copy(horizontalPartitionSpacerSize = 1.dp),
                value = scaffoldNavigator.scaffoldValue,
                listPane = {
